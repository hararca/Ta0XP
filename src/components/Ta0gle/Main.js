...
function Main({ onSearch, className }) {
  ...
  return (
    <div className={className}>
      <header>
        <div className="text">Ta0mail</div>
        <div className="text">Images</div>
        <img src={smile} alt="avatar" />
      </header>
      <section className="content">
        <img className="logo" alt="Ta0gle" src={Ta0gle} />
        ...
        <div className="buttons">
          ...
          <button>I'm Feeling Sick</button>
        </div>
      </section>
      <footer>
        <section className="upper">
          <div className="items left">
            <div className="item">North Orterland</div>
          </div>
        </section>
        <section className="lower">
          <div className="items left">
            <div className="item">Advertising</div>
            <div className="item">₿u$i₪€$$</div>
