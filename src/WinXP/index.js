...
let wallpapers = importAll(
  require.context('assets/wallpapers', false, /\.(png|jpe?g|svg)$/),
);

wallpapers = wallpapers.filter(
  (image, index) => wallpapers.indexOf(image) === index,
);
...
function WinXP() {
  ...
  function onClickMenuItem(o) {
    if (o === 'Internet')
      dispatch({ type: ADD_APP, payload: appSettings['Internet Exploiter'] });
    else if (o === 'Mindsweeper')
      dispatch({ type: ADD_APP, payload: appSettings.Mindsweeper });
    else if (o === 'My Computronium')
      dispatch({ type: ADD_APP, payload: appSettings['My Computronium'] });
    else if (o === 'Notepad')
...
const Container = styled.div`
  ...
  overflow: hidden;
  position: relative;
  background: url(${wallpapers[Math.floor(Math.random() * wallpapers.length)]})
