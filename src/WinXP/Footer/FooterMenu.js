  ...
  return (
    <div className={className}>
      <header>
        ...
        <span className="header__text">Tendiendo a 0</span>
      </header>
      <section className="menu" onMouseOver={onMouseOver}>
        <hr className="orange-hr" />
        <div className="menu__left">
          <Item onClick={onClick} text="Internet" icon={ie}>
            <div className="menu__item__subtext">Internet Exploiter</div>
          </Item>
        ...
        <div className="menu__right">
          ...
          <Items
            ...
            items={[
              ...
              { icon: computer, text: 'My Computronium' },
            ]}
          />
          <div className="menu__separator" />
          <Items
