...
import mine from 'assets/mindsweeper/mine-icon.png';
import windows from 'assets/windowsIcons/windows.png';
import scream from 'assets/armageddonscream.gif';
    ...
    <Div>
      ...
      <section className="com__address_bar">
        ...
        <div className="com__address_bar__content">
          ...
          />
          <div className="com__address_bar__content__text">My Computronium</div>
          <img
            src={dropdown}
            alt="dropdown"
            className="com__address_bar__content__img"
        ...
        <div className="com__content__inner">
            ...
            <div className="com__content__left__card">
              ...
              <div className="com__content__left__card__content">
                ...
                <div className="com__content__left__card__row">
                  ...
                  />
                  <a
                    href="https://github.com/ShizukuIchi/mindsweeper"
                    target="_blank"
                    rel="noreferrer"
                    className="com__content__left__card__text link"
                  >
          ...
          <div className="com__content__right">
            ...
            <div className="com__content__right__card com__content__right__card--me">
              <div className="com__content__right__card__header">About Ta0</div>
              <div className="com__content__right__card__content">
                <a
                  href="https://soundcloud.com/tendiendoacero"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://archive.org/search?query=creator%3A%22Tendiendo+a+Cero%22"
                  target="_blank"
                  rel="noreferrer"
                  className="circle-link"
                >
                ...
                <a
                  href="https://instagram.com/flipekdiq"
                  target="_blank"
                  rel="noreferrer"
                  className="circle-link"
                >
                ...
                <a
                  href="https://www.mixcloud.com/Kadiq/"
                  target="_blank"
                  rel="noreferrer"
                  className="circle-link"
                >
                ...
                <a
                  href="https://www.facebook.com/tendiendo.acero/"
                  target="_blank"
                  rel="noreferrer"
                  className="circle-link"
                >
                ...
                <a
                  href="https://www.ivoox.com/podcast-tendiendo-a-cero_sq_f11136860_1.html"
                  target="_blank"
                  rel="noreferrer"
                  className="circle-link"
                >
